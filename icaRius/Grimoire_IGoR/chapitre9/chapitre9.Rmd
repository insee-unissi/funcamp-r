...
naissances <- read_csv2(file="../../data/chapitre9/naissances.csv")
```
...
```{r ok-chapitre9-etape1,exercise=TRUE}
...
```{r ok-chapitre9-etape2,exercise=TRUE}
...
```{r ok-chapitre9-etape3,exercise=TRUE}
