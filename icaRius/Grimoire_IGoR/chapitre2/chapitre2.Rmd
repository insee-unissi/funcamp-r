...
```{r, collapse = FALSE}
# Je charge le fichier pontes_semaine1.xls en indiquant son chemin
...
D'après-vous, comment allons-nous charger ce fichier csv dans R ? Eh oui: toujours avec le même sortilège `import()` ! Vous savez désormais comment procéder : à vous de charger le fichier `pontes_semaine3.csv` dans la console R, en la sauvegardant dans l'objet nommé `livre_compte_4` 


```{r, collapse = TRUE}
livre_compte_4 <- import("E:/icaRius/data/pontes_semaine3.csv")
```
