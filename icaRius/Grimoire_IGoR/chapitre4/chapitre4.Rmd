...
<p>
<p>
On peut également choisir de ne s'intéresser qu'à une seule des variables du fichier :
...
Continuons avec l'exploitation du fichier des fermiers Tellus et Galia, avec le sortilège `skim()`
