---
title: "Chapitre optionnel 1 - le labyrinthe"
output: 
  html_document:
    theme: cerulean
    highlight: haddock
...
```{r module3-question1,exercise=TRUE}
...
Il est possible d'**afficher les noms** associés à un vecteur en utilisant la fonction `names()` - cette même fonction que celle utilisée pour trouver les noms des colonnes dans un fichier (voir chapitre 2).
...
```{r module3-question2,exercise=TRUE}
# Les deux vecteurs sont déjà chargés sous les noms
# vecteur_choix et vecteur_seuil
...
Armés de nos vecteurs comme d'une épée vorpale, nous voici en mesure d'affronter les plus grands dangers... comme le *calcul vectoriel* ! R permet de réaliser des opérations mathématiques sur les vecteurs, à commencer par de l'arithmétique : addition, soustraction, multiplication...
...
```{r module3-question3,exercise=TRUE}
# Les deux vecteurs sont déjà chargés sous les noms
# vecteur_choix et vecteur_seuil
