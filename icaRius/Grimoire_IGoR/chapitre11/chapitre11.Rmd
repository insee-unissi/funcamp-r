...
Vous voilà revenu(e) au tout début de l'aventure ! Comme d'ouvrir le grimoire IGoR au premier chapitre. Tout ce chemin accomplir pour rien : quelle frustration... L'automate TeCo vous a en effet projeté en arrière, faute de maîtriser la "statistique reproductible"...
...
## Automatisons avec l'automate TeCo 
...
Ce faisant, un tout premier a été fait dans l'idée de reproductibilité, en utilisant comme ingrédient dans votre formule runique des "variables" dont la valeur peut être modifiée, plutôt que d'écrire directement le calcul avec les valeurs finales.

L'idée est équivalente au fait d'utiliser des variables dans une équation :
...
Pas sorcier finalement. Comme quoi, cette histoire d'automate TeCo, c'est très surfait. Pour utiliser votre tout nouveau sortilège, il suffit de l'invoquer avec la valeur souhaitée pour l'ingrédient `nb_coeur`
