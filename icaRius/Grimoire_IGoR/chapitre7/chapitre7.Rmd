---
title: "Chapitre 7 - la plume d'IGoR"
output: 
  html_document:
    theme: cerulean
    highlight: haddock
...
Pour certaines tâches, il peut exister plusieurs solutions différentes pour les réaliser. Dans la mesure où il n’est pas possible d’être exhaustif, nous avons fait le choix dans l'aventure d'icaRius de retenir en priorité les sortilèges du tidyverse. En particulier, dans de prochains chapitres, vous ferez la découverte de `dplyr` pour la manipulation de données et de `ggformula` pour la réalisation de graphiques.
...
**Fin du chapitre 7 >> reprenez la partie d'Icarius !!!** 