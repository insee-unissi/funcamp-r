...
donnees_secretes <- read_excel("../../data/chapitre6/nbguerriers.xlsx")
...
head(donnees_secretes)
```

```{r, collapse = TRUE, echo=FALSE, eval=T}
head(donnees_secretes_df)
```
...
```{r chapitre6-etape1,exercise=TRUE}
# Créez le graphique
