...
fichier_tellus<-read_ods(path="../../data/chapitre3/recensement_agricole_statia_Tellus.ods")
fichier_galia<-read_ods(path="../../data/chapitre3/recensement_agricole_statia_Galia.ods")
```
