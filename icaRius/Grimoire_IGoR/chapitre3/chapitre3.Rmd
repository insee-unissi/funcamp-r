...
fichier_tellus<-read_ods(path="E:/icaRius/data/chapitre3/recensement_agricole_statia_Tellus.ods")
fichier_galia<-read_ods(path="E:/icaRius/data/chapitre3/recensement_agricole_statia_Galia.ods")
```
...
><p><font size="2">
>
>Les deux exploitations ont une production moyenne différente : la valeur `mean` de la variable Litres dans les résultats du sortilè skim() donne en effet une moyenne respective de 33,9 litres et 36,5 litres pour les exploitations de Tellus et Galia. 
>
