...
- ``r names(prenoms)[5]`` est la proportion d'enfants portant ce prénom pour une année et un département donné (il s'agit de l'effectif divisé par la somme des naissances dans le département)
