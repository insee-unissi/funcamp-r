...
Dans l'exemple ci-dessus, la bonne adresse pour notre fichier de ponte c'est donc `E:/icaRius/data/pontes.csv`. Il nous reste simplement à préciser le séparateur, qui est ici une virgule `,`. C'est parti :
